...
create table Productos_has_Platos(
	Productos_codigoProducto int not null unique,
...
create table Servicios_has_Platos(
	Servicios_codigoServicio int not null unique,
    codigoPlato int not null,
...
call sp_AgregarUsuario('Lester','López','Less','1234567');
call sp_AgregarUsuario('Fundación','Kinal','Kinal','Kinal2023');
